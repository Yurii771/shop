 ...
 */
class Categories extends \Admin\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'name', '' . "\0" . 'Admin\\Entity\\Categories' . "\0" . 'parent'];
        }
