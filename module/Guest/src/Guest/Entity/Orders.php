...
class Orders
{
     ...
     * @return Orders
     */
    public function setCity(\Guest\Entity\Cities $city = null)
    {
        $this->city = $city;
     ...
     * @return Orders
     */
    public function setPayment(\Guest\Entity\Payment $payment = null)
    {
     ...
     * @return Orders
     */
    public function setDelivery(\Guest\Entity\Delivery $delivery = null)
    {
     ...
     * @return Orders
     */
    public function setOrderStatus(\Guest\Entity\OrderStatus $orderStatus = null)
    {
